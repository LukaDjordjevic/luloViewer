      ...
      <div className="viewer" ref={el => (this.mainDiv = el)}>
        ...
        >
          <div
            ...
            style={{
              width: `${this.state.slidesRect.width}px`,
              height: `${this.state.slidesRect.height}px`
            }}
          >
          ...
          <div
            ...
            style={{
              width: `${this.state.sliderRect.width}px`,
              height: `${this.state.sliderRect.height}px`
            }}
          />
        </div>
      </div>
